...
*** Likely from link:https://www.phoronix.com/scan.php?page=news_item&px=MGLRU-Not-For-5.18[Linux kernel 5.19 and beyond] there'd be substantial improvements to OOM situations, that make `systemd-oomd` and `earlyoom` not helpful.
